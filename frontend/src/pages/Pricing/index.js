...
function Pricing() {
  ...
  try {
    ...
    if (
      ...
      !values.minimum_fee ||
      !values.daily_max_fee ||
      !values.peak_hours_start ||
      !values.peak_hours_end ||
      !values.peak_rate_multiplier
    ) {
    ...
    message.error("Vui lòng nhập đúng dữ liệu");
  }
};

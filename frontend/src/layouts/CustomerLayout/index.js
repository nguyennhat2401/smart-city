...
function CustomerLayout() {
  ...
  // check login trực tiếp từ localStorage
      ...
      <header className="header">
        <div className="menu">
          ...
          <div className="menu__logo">
            <NavLink to="/">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4H8II3m_0MtTF6PhATjsVIBLxQT0J20g4LB55LBYSxfUEPKfag2t0XU8&s"
                alt="logo"
              />
            </NavLink>
          </div>
          ...
          <div className={`menu__item ${openMenu ? "active" : ""}`}>
            <ul>
              ...
              {isLogin && (
                <>
                  <li className="menu__default">
                    <NavLink to="/emptypaking" onClick={closeMenu}>
                      Xem chỗ trống
                    </NavLink>
                  </li>

                  <li className="menu__default">
                    <NavLink to="/prebooking" onClick={closeMenu}>
                      Đặt chỗ trước
                    </NavLink>
                  </li>

                  <li className="menu__default">
                    <NavLink to="/monthlypasscustomer" onClick={closeMenu}>
                      Đặt vé tháng
                    </NavLink>
                  </li>

                  <li className="menu__default">
                    <NavLink to="/checkin" onClick={closeMenu}>
                      Checkin
                    </NavLink>
                  </li>
      ...
      <footer className="footer">
        ...
        <div className="footer__detail">
          ...
          <div className="footer__detail__introduce">
            <div className="footer__detail__introduce__title">
              GIỚI THIỆU
            </div>
            ...
            <div className="footer__detail__introduce__content">
              ...
              <div className="footer__detail__introduce__content__inner">
                <NavLink to="/operatingregulations">
                  Quy chế hoạt động
                </NavLink>
              </div>
          ...
          <div className="footer__detail__clause">
            ...
            <div className="footer__detail__clause__title">
              ĐIỀU KHOẢN
            </div>
        ...
        <div className="footer__inforBusiness">
          ...
          <div className="footer__inforBusiness__logo">
            <img
              src="https://ttz.com.vn/wp-content/uploads/2025/09/bien-bao-bai-do-xe-003.jpg"
              alt="logo"
            />
          </div>

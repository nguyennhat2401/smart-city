...
def available_slots(request, lot_id):
    ...
    try:
        ...
        return Response({
            ...
            "rate_per_hour": lot.pricing.rate_per_hour,
            "minimum_fee": lot.pricing.minimum_fee,
            "daily_max_fee": lot.pricing.daily_max_fee,

            "peak_hours_start": lot.pricing.peak_hours_start,
            "peak_hours_end": lot.pricing.peak_hours_end,
            "peak_rate_multiplier": lot.pricing.peak_rate_multiplier,
